...
class UserServiceImplTest {
    ...
    @Test void createUser_shouldSaveUserAndWallet() {
    ...
    @Test void createUser_shouldRejectDuplicateEmail() {
        CreateUserRequestDTO request = new CreateUserRequestDTO("Test", "test@example.com", "password");
    ...
    @Test void deleteUser_shouldDeleteExistingUser() {
        User u = new User(1L,"a@b.com","A","p",Role.USER);
        when(userRepository.findById(1L)).thenReturn(Optional.of(u));
